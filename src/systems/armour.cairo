...
pub mod ArmourActions {
    ...
    impl ArmourActionsImpl of IArmour<ContractState> {
        ...
        fn set_armour_effect(ref self: ContractState, id: u256, effect: felt252) {// TODO: Implement world storage operations
        }

        fn utilize_armour(ref self: ContractState, id: u256) {// TODO: Implement world storage operations
        }

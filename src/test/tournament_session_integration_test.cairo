...
use coa::systems::tournament::{ITournamentDispatcher, ITournamentDispatcherTrait, TournamentActions};
...
fn test_tournament_session_auto_renewal() {
    ...
    start_cheat_block_timestamp(tournament_dispatcher.contract_address, 4300); // 5 minutes before expiry
